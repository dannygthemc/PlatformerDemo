...
const speed = 1500 #constant speed
const dmg = 1 #constant damage
var health = 10 #integer to represent health points
...
var anim = "move" #reference to animation

#gets damage value of enemy
func getDamage():
	return dmg
	
#enemy takes specified amount of damage
func takeDamage(dam):
	health = health - dam
...
func _fixed_process(delta):
	...
	var speed_x = 0 #set x speed to 1, moves along x axis
	var speed_y = 1 #set y speed to 0, doesn't move up or down
	if backwards:
